...
public class HighlightView {
    ...
    // 1 for original colony 
    // 2 for added colony
    // 3 for removed colony
    private int type;
...
//        // Log.d("test4", "after map: r.left = " + r.left + ", r.top = " + r.top + ", r.right = " + r.right + ", r.bottom = " + r.bottom);
    ...
    public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean circle, boolean maintainAspectRatio, int type) {
        if (circle) {
    ...
    public Drawable getResizeDrawableDiagonal(){
    	return mResizeDrawableDiagonal;
    }
